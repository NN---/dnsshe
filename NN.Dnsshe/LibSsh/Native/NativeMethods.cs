...
namespace NN.Dnsshe.LibSsh.Native
{
    ...
    public static class NativeMethods
    {
...
#elif TARGET_LINUX
        public const string LibSshNative = "libssh.so";
#elif TARGET_MACOS
        public const string LibSshNative = "libssh.dylib";
#endif
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshChannel ssh_channel_accept_x11(SafeSshChannel channel, int timeout_ms);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_change_pty_size(SafeSshChannel channel, int cols, int rows);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_close(SafeSshChannel channel);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_open_auth_agent(SafeSshChannel channel);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_open_forward(
            SafeSshChannel channel,
            string remotehost,
            int remoteport,
            string sourcehost,
            int localport);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_open_forward_unix(
            SafeSshChannel channel,
            string remotepath,
            string sourcehost,
            int localport);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_open_x11(SafeSshChannel channel, string orig_addr, int orig_port);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_channel_read_timeout(
            SafeSshChannel channel,
            byte[] dest,
            uint count,
            bool is_stderr,
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_channel_read_nonblocking(
            SafeSshChannel channel,
            byte[] dest,
            uint count,
            bool is_stderr);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_request_pty_size(
            SafeSshChannel channel,
            string term,
            int cols,
            int rows);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_request_x11(
            SafeSshChannel channel,
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_send_eof(SafeSshChannel channel);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_channel_select(
            SafeSshChannel readchans,
            SafeSshChannel writechans,
            SafeSshChannel exceptchans,
            in timeval timeout);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_channel_set_blocking(SafeSshChannel channel, bool blocking);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_channel_set_counter(SafeSshChannel channel, in ssh_counter_struct counter);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshConnector ssh_connector_new(SafeSshSession session);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_connector_free(ssh_connector connector);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_connector_set_in_channel(
            SafeSshConnector connector,
            SafeSshChannel channel,
            ssh_connector_flags_e flags);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_connector_set_out_channel(
            SafeSshConnector connector,
            SafeSshChannel channel,
            ssh_connector_flags_e flags);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_connector_set_in_fd(SafeSshConnector connector, socket_t fd);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_connector_set_out_fd(SafeSshConnector connector, socket_t fd);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr ssh_channel_accept_forward(
            SafeSshSession session,
            int timeout_ms,
            ref int destination_port);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_get_publickey_hash(
            SafeSshKey key,
            ssh_publickey_hash_type type,
            out SafePublicKeyHash hash,
            out nuint hlen);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [Obsolete("Use " + nameof(ssh_get_publickey_hash))]
        public static extern int ssh_get_pubkey_hash(SafeSshSession session, out SafePublicKeyHash hash);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_forward_listen(
            SafeSshSession session,
            string address,
            int port,
            ref int bound_port);
        ...
        public static extern ssh_server_known_e ssh_is_server_known(SafeSshSession session);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_known_hosts_e ssh_session_get_known_hosts_entry(
            SafeSshSession session,
            ref IntPtr pentry);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshChannel ssh_message_channel_request_open_reply_accept(SafeSshMessage msg);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_message_channel_request_open_reply_accept_channel(SafeSshMessage msg, SafeSshChannel chan);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_message_channel_request_reply_success(SafeSshMessage msg);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_message_free(ssh_message msg);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshMessage ssh_message_get(SafeSshSession session);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_message_subtype(SafeSshMessage msg);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_message_type(SafeSshMessage msg);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_options_copy(SafeSshSession src, out SafeSshSession dest);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_pcap_file_close(SafeSshPcapFile pcap);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_pcap_file_free(ssh_pcap_file pcap);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshPcapFile ssh_pcap_file_new();

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_pcap_file_open(SafeSshPcapFile pcap, string filename);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_pki_import_pubkey_base64(SafeSshChar b64_key, ssh_keytypes_e type, out SafeSshKey pkey);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_pki_import_cert_base64(SafeSshChar b64_cert, ssh_keytypes_e type, out SafeSshKey pkey);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_error_e ssh_pki_export_pubkey_base64(SafeSshKey key, out SafeSshChar b64_key);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr ssh_get_fingerprint_hash(ssh_publickey_hash_type type, SafePublicKeyHash hash, nuint len);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_print_hash(ssh_publickey_hash_type type, SafePublicKeyHash hash, nuint len);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_send_ignore(SafeSshSession session, byte[] data);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_send_debug(SafeSshSession session, byte[] message, bool always_display);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_gssapi_set_creds(SafeSshSession session, ssh_gssapi_creds creds);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_accept_request(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_close(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_deny_request(SafeSshScp scp, string reason);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_scp_free(ssh_scp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_init(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_leave_directory(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshScp ssh_scp_new(SafeSshSession session, int mode, string location);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_pull_request(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_push_directory(SafeSshScp scp, string dirname, int mode);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_push_file(SafeSshScp scp, string filename, nuint size, int perms);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_push_file64(SafeSshScp scp, string filename, ulong size, int perms);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_read(SafeSshScp scp, IntPtr buffer, nuint size);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr ssh_scp_request_get_filename(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_request_get_permissions(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern nuint ssh_scp_request_get_size(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ulong ssh_scp_request_get_size64(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr ssh_scp_request_get_warning(SafeSshScp scp);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_scp_write(SafeSshScp scp, IntPtr buffer, nuint len);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_select(
            ref SafeSshChannel channels,
            ref IntPtr outchannels,
            socket_t maxfd,
            ref fd_set readfds,
            ref timeval timeout);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_set_blocking(SafeSshSession session, bool blocking);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_set_counters(
            SafeSshSession session,
            in ssh_counter_struct scounter,
            in ssh_counter_struct rcounter);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_set_pcap_file(SafeSshSession session, SafeSshPcapFile pcapfile);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_auth_e ssh_userauth_kbdint(SafeSshSession session, string user, string? submethods);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr ssh_userauth_kbdint_getprompt(SafeSshSession session, uint i, in IntPtr echo);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ssh_auth_e ssh_userauth_gssapi(SafeSshSession session);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_getpass(string prompt, char[] buf, nuint len, bool echo, bool verify);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshEvent ssh_event_new();

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_add_fd(
            SafeSshEvent @event,
            socket_t fd,
            short events,
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_add_session(SafeSshEvent @event, SafeSshSession session);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_add_connector(SafeSshEvent @event, SafeSshConnector connector);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_dopoll(SafeSshEvent @event, int timeout);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_remove_fd(SafeSshEvent @event, socket_t fd);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_remove_session(SafeSshEvent @event, SafeSshSession session);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_event_remove_connector(SafeSshEvent @event, SafeSshConnector connector);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_event_free(ssh_event @event);
        ...
        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SafeSshBuffer ssh_buffer_new();

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void ssh_buffer_free(ssh_buffer buffer);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_buffer_reinit(SafeSshBuffer buffer);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ssh_buffer_add_data(SafeSshBuffer buffer, byte[] data, uint len);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint ssh_buffer_get_data(SafeSshBuffer buffer, byte[] data, uint requestedlen);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr ssh_buffer_get(SafeSshBuffer buffer);

        [DllImport(
            LibSshNative, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint ssh_buffer_get_len(SafeSshBuffer buffer);
    }
    ...
    public delegate int ssh_auth_callback(string prompt, IntPtr buf, IntPtr len, int echo, int verify, IntPtr userdata);

    public delegate int ssh_event_callback(IntPtr fd, int revents, IntPtr userdata);
}
